            ...
            <form method="POST">
                ...
                <div class="form-group">
                    <label> Kode Buku : </label>
                    	<input class="form-control" name="kode_buku" value="<?php echo $tampil['kode_buku']; ?>"/>
                </div>
                ...
                <div>
                	<input type="submit" name="simpan" value="Ubah Data" class="btn btn-success">
                </div>
            </form>
        </div>
	</div>
...
<?php
    ...
    if ($simpan) {
        ...
        $sql = $koneksi->query("update tb_buku set judul='$judul', pengarang='$pengarang', penerbit='$penerbit', tahun_terbit='$tahun', kode_buku='$kode_buku', jumlah_buku='$jumlah', lokasi='$lokasi', tgl_input='$tanggal' where id='$id'"); 
